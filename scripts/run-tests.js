...
const TESTS = {
  ...
  'ai-processed-tag-without-tags': 'test-ai-processed-tag-without-tags.js',
  ...
  'ai-run-estimate': 'test-ai-run-estimate.js',
  'ai-run-cost': 'test-ai-run-cost.js',
